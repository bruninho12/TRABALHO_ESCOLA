 ...
 *   - name: Notificações
 *     description: Operações relacionadas às notificações
 *   - name: Dashboard
 *     description: Operações relacionadas ao dashboard
 */
 ...
 *                 message:
 *                   type: string
 *                   example: "Token de atualização inválido ou expirado"
 *
 ...
 *                 message:
 *                   type: string
 *                   example: "Email de redefinição de senha enviado"
 *       400:
 *         $ref: '#/components/responses/ValidationError'
 *       404:
 ...
 *                 message:
 *                   type: string
 *                   example: "Nenhum usuário encontrado com este email"
 *
