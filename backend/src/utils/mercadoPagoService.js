...
class MercadoPagoService {
        ...
        try {
            const preference = {
                items: [{
                    ...
                    description: paymentData.description || 'Assinatura Premium DespFinance',
                    quantity: 1,
            ...
            console.error('Erro ao criar preferência MercadoPago:', error.response?.data || error.message);
    ...
    async createDirectPayment(paymentData) {
        try {
            ...
            if (paymentData.paymentMethodId === 'pix') {
                payment.date_of_expiration = new Date(Date.now() + 30 * 60 * 1000).toISOString(); // 30 min
            ...
            console.error('Erro ao criar pagamento MercadoPago:', error.response?.data || error.message);
    ...
    async createSubscription(subscriptionData) {
        try {
            ...
            console.error('Erro ao criar assinatura MercadoPago:', error.response?.data || error.message);
    ...
    async createSubscriptionPlan(planData) {
        try {
            ...
            console.error('Erro ao criar plano MercadoPago:', error.response?.data || error.message);
    ...
    async getPayment(paymentId) {
        try {
            ...
            console.error('Erro ao buscar pagamento MercadoPago:', error.response?.data || error.message);
    ...
    async cancelPayment(paymentId) {
        try {
            ...
            console.error('Erro ao cancelar pagamento MercadoPago:', error.response?.data || error.message);
    ...
    async refundPayment(paymentId, amount = null) {
        try {
            ...
            console.error('Erro ao reembolsar pagamento MercadoPago:', error.response?.data || error.message);
    ...
    async getSalesReport(startDate, endDate) {
        try {
            ...
            console.error('Erro ao gerar relatório MercadoPago:', error.response?.data || error.message);
