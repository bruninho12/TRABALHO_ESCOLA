          ...
          >
            ...
            >
              <Grid item xs={12} lg={6}>
                ...
                >
                  <motion.div
                    animate={enableVisualEffects ? { scale: [1, 1.005, 1] } : undefined}
                    transition={
                      enableVisualEffects
                        ? {
                            duration: 6,
                  ...
                  >
                        ...
                        sx={{
                          ...
                          "&::after": {
                            ...
                            background:
                              "linear-gradient(135deg, #6366f1, #ec4899)",
                            borderRadius: 2,
                            animation: enableVisualEffects ? "pulse 2s infinite" : "none",
                          },
                          "@keyframes pulse": {
                    ...
                    <motion.div
                      initial={enableVisualEffects ? { opacity: 0, y: 12 } : false}
                      animate={enableVisualEffects ? { opacity: 1, y: 0 } : { opacity: 1 }}
                      transition={
                        enableVisualEffects
